...
export const PHOTO = {
  ...
  scrimCover: 'linear-gradient(to bottom, rgba(0,0,0,.84) 0%, rgba(0,0,0,.62) 8%,'
            + ' rgba(0,0,0,0) 19%, rgba(0,0,0,0) 44%,'
            + ' rgba(0,0,0,.58) 60%, rgba(0,0,0,.90) 78%, rgba(0,0,0,.95) 100%)',
  // 내지: 사진을 배경 질감으로 깔고 글이 앞으로 나오게 전면을 눌러줌
  // 내지도 사진이 위쪽에 살아 있고 아래쪽만 강하게 누름
  scrimBody: 'linear-gradient(to bottom, rgba(0,0,0,.84) 0%, rgba(0,0,0,.60) 9%,'
           + ' rgba(0,0,0,.26) 24%,'
