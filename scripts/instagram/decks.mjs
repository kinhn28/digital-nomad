...
DECKS.push({
  ...
  slides: [
    { kind: 'photo', place: '이유식 알러지 테스트', cat: '육아꿀팁',
      head: ['다들 이렇게 하더라', '알러지 테스트 3가지'] },

    { kind: 'photoBody',
      body: ['<span class="n2">첫째</span>새 재료는 하루에 딱 하나씩.',
             '두세 개를 같이 넣으면 반응이 와도 뭐 때문인지 알 수가 없거든.\n하윤이네도 그러다 처음부터 다시 했대.'] },

    { kind: 'photoBody',
      body: ['<span class="n2">둘째</span>먹이는 시간은 아침이나 점심.',
             '낮에 먹여야 이상이 있어도 병원 문 열었을 때 갈 수 있으니까.\n저녁에 처음 먹였다가 밤에 당황했다는 얘기가 제일 많더라.'] },

    { kind: 'photoBody',
      body: ['<span class="n2">셋째</span>한 가지 넣고 사나흘은 지켜보기.',
             '바로 안 나오고 며칠 뒤에 올라오는 경우도 있대.\n뭘 언제 먹였는지 메모해두면 나중에 훨씬 편해.'] },

    { kind: 'photoBody',
      body: ['발진이나 이상이 보이면 그 재료는 일단 멈추고 소아과에 확인받는 게 먼저야.',
             '여긴 부모들끼리 나눈 경험이고, 판단은 병원에서 받는 거니까.'] },
